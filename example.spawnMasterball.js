...
server = new PokemonGoMITM({
  port: 8081
}).addResponseHandler("FortSearch", function(data) {
  data.items_awarded = [
    {
      item_type: 'ITEM_MASTER_BALL',
      item_count: 1
    }, {
      item_type: 'ITEM_SPECIAL_CAMERA',
      item_count: 1
    }, {
      item_type: 'ITEM_PINAP_BERRY',
      item_count: 1
    }, {
      item_type: 'ITEM_STORAGE_UPGRADE',
      item_count: 1
    }
  ];
